//helper method to return a user-friendly error message when things go wrong
export const getDisplayErrorMessage = (error_code) => {
    const authErrors = {
      'auth/argument-error': '',
    ...
    if (authErrors[error_code] !== null) {
      return authErrors[error_code];
    }
